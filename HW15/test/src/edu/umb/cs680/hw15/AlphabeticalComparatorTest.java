...
class AlphabeticalComparatorTest {
	...
	public void verifyGetChildrenTest() {
		...
		LinkedList<ApfsElement> actual = dir
				.getChildren((ApfsElement obj1, ApfsElement obj2) -> obj1.getName().compareTo(obj2.getName()));
	...
	public void verifygetSubDirectoriesTest() {
		...
		LinkedList<ApfsDirectory> actual = dir
				.getSubDirectories((ApfsElement obj1, ApfsElement obj2) -> obj1.getName().compareTo(obj2.getName()));
	...
	public void verifygetFilesTest() {
		...
		LinkedList<ApfsFile> actual = dir
				.getFiles((ApfsElement obj1, ApfsElement obj2) -> obj1.getName().compareTo(obj2.getName()));
