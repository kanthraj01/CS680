...
class ApfsLinkTest {
	...
	ApfsFile b = new ApfsFile(applications, "b", 15, dateTime, "ApfsFile", dateTime);
	ApfsFile c = new ApfsFile(home, "c", 20, dateTime, "ApfsFile", dateTime);
	ApfsFile d = new ApfsFile(home, "d", 50, dateTime, "ApfsFile", dateTime);
	ApfsFile e = new ApfsFile(code, "e", 10, dateTime, "ApfsFile", dateTime);
	ApfsFile f = new ApfsFile(code, "f", 20, dateTime, "ApfsFile", dateTime);
